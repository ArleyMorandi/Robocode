...
public class GangueDaMotoca extends AdvancedRobot {
  ...
  public void run() {
    ...
    while (true) {
      ...
      if (getX() <= 50 || getY() <= 50 || getBattleFieldWidth() - getX() <= 50 || getBattleFieldHeight() - getY() <= 50) {
        // Se estiver perto de uma parede, vira 180 graus e move na direção oposta
  ...
  public void onScannedRobot(ScannedRobotEvent e) {
    ...
    // Atira baseado na energia do inimigo e na distância
  ...
  public void onHitWall(HitWallEvent e) {
    ...
    // Vira o robô para longe da parede
    setTurnRight(180);
